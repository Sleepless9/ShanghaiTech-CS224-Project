...
public class CMAESOptimizerTest {
    ...
    public void testLoadExpIntA() {
        ...
        assertEquals("EXP_INT_A array should have correct length", 1024, result.length);
    ...
    public void testLoadExpIntB() {
        ...
        // Test that the array has the expected length
        assertEquals("EXP_INT_B array should have correct length", 1024, result.length);
    ...
    public void testLoadExpFracA() {
        ...
        // Test that the array has the expected length
        assertEquals("EXP_FRAC_A array should have correct length", 1024, result.length);
    ...
    public void testLoadExpFracB() {
        ...
        // Test that the array has the expected length
        assertEquals("EXP_FRAC_B array should have correct length", 1024, result.length);
        ...
        assertNotSame("EXP_FRAC_B should be a different array from EXP_FRAC_A", expFracA, result);
        
        // Test that values are generally small (correction terms)
        for (int i = 0; i < result.length; i++) {
            assertTrue("Correction terms should be small at index " + i, 
    ...
    public void testLoadLnMant() {
        ...
        assertEquals("LN_MANT array should have correct number of rows", 1024, result.length);
        ...
        // Test that the last row has reasonable values
        assertTrue("Last row first column should be positive", result[1023][0] > 0);
    ...
    public void testArrayConsistency() {
        ...
        assertEquals("LN_MANT should have same number of rows as other arrays", 
                    expIntA.length, lnMant.length);
    }
}