...
public class DateTimeFormatterTest {
    ...
    public void testAppendTimeZoneOffset() {
        ...
        DateTime parsedWithOffset = formatter.parseDateTime("14:30 +05:30");
        assertEquals(14, parsedWithOffset.getHourOfDay());
        assertEquals(30, parsedWithOffset.getMinuteOfHour());
    }
